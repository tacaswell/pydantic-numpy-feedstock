...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pydantic-numpy-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pydantic-numpy-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pydantic-numpy
# for installing globally
pixi global install pydantic-numpy
```
...
It is possible to list all of the versions of `pydantic-numpy` available on your platform:
...
```
pixi search pydantic-numpy --channel conda-forge
```
